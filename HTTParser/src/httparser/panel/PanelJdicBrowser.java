...
public class PanelJdicBrowser extends PanelBrowser {
	...
	private static final long serialVersionUID = -973334826738710362L;
  ...
  private JButton jStopButton = new JButton("Stop", new ImageIcon(getClass().getResource("../ressource/icone/jdic/Stop.png")));
  private JButton jRefreshButton = new JButton("Refresh", new ImageIcon(getClass().getResource("../ressource/icone/jdic/Reload.png")));
  private JButton jForwardButton = new JButton("Forward", new ImageIcon(getClass().getResource("../ressource/icone/jdic/Forward.png")));
  private JButton jBackButton = new JButton("Back", new ImageIcon(getClass().getResource("../ressource/icone/jdic/Back.png")));
  ...
  private BoxStatusBar statusBar = new BoxStatusBar();
...
/*
      try {
          webBrowser = new WebBrowser(true);//new URL("http://java.net"));
...
*/
      ...
      webBrowser.addWebBrowserListener(new WebBrowserListener() {
          ...
          public void downloadCompleted(WebBrowserEvent event) {
    	      ...
    	      //if ( getParentFrame().getRunnerLink() != null ) synchronized(getParentFrame().getRunnerLink()){getParentFrame().getRunnerLink().notifyAll();}
    	      if (webBrowser.getURL()!=null)
    	      	getParentFrame().setTitle("Current URL:"+webBrowser.getURL().toString());
          ...
          public void downloadError(WebBrowserEvent event) {
    	      ...
    	      if ( getParentFrame().getRunnerLink() != null ) synchronized(getParentFrame().getRunnerLink()){getParentFrame().getRunnerLink().notifyAll();}
    	      getParentFrame().setTitle("Error Current URL:"+webBrowser.getURL().toString());
          ...
          public void documentCompleted(WebBrowserEvent event) {
    	      ...
    	      if ( getParentFrame().getRunnerLink() != null ) synchronized(getParentFrame().getRunnerLink()){getParentFrame().getRunnerLink().notifyAll();}
    	      getParentFrame().setTitle("Completed Current URL:"+webBrowser.getURL().toString());
