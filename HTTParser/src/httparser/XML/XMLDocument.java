...
public class XMLDocument {
  ...
  public void add(String szName, Vector lstData) throws UnsupportedEncodingException
  {
  ...
  public void add(String szName, String szData) throws UnsupportedEncodingException
  {
  ...
  public void addData(String szData) throws UnsupportedEncodingException
  {
    //this.getDocument().append(java.net.URLEncoder.encode(szData));
    this.getDocument().append(java.net.URLEncoder.encode(szData, "UTF-8"));
  }
  ...
  public void write(String szFileName)
  {
    ...
    if ( !szFileName.substring(szFileName.length()-extension.length()).equalsIgnoreCase(extension) )
    	szFileName = szFileName + extension;
    try
    {
