...
/*    Generated:  September 2nd 2009 3:50:37 PM PDT                            */
/*      Machine:  10.16.139.109                                                */
/*       Source:  Global Cache                                                 */
/*     Location:  js/ec01ciwev88ckgco.pkg.js h:em7e4sao                        */
/*       Locale:  nu_ll                                                        */
...
function pymk_disable_add_friend_links(uid){var add_links=DOM.scry(document,'a.fg_add_'+uid);for(var i=0;i<add_links.length;i++){var newNode=$N('span',{className:'holder inactive'},_tx("Demande d'ajout \u00e0 une liste d'amis en attente"));DOM.replace(add_links[i],newNode);}
